...
[Back to Cloud Architecture topics](README.md) | [Module guide](../14-cloud-architecture.md)

## Learning checklist

- [ ] Explain Google Cloud Platform in your own words.
...
1. What requirement makes Google Cloud Platform relevant?
...
Apply this topic to the exercise in the [Module 14 guide](../14-cloud-architecture.md), then record the decision and its trade-offs.
