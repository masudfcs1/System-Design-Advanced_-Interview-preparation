...
[Back to Security topics](README.md) | [Module guide](../12-security.md)

## Learning checklist

- [ ] Explain Attribute-Based Access Control (ABAC) in your own words.
...
1. What requirement makes Attribute-Based Access Control (ABAC) relevant?
...
Apply this topic to the exercise in the [Module 12 guide](../12-security.md), then record the decision and its trade-offs.
