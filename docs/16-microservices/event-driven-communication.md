...
[Back to Microservices topics](README.md) | [Module guide](../16-microservices.md)

## Learning checklist

- [ ] Explain Event-Driven Communication in your own words.
...
1. What requirement makes Event-Driven Communication relevant?
...
Apply this topic to the exercise in the [Module 16 guide](../16-microservices.md), then record the decision and its trade-offs.
