...
[Back to Data Engineering Concepts topics](README.md) | [Module guide](../18-data-engineering.md)

## Learning checklist

- [ ] Explain Online Transaction Processing (OLTP) in your own words.
...
1. What requirement makes Online Transaction Processing (OLTP) relevant?
...
Apply this topic to the exercise in the [Module 18 guide](../18-data-engineering.md), then record the decision and its trade-offs.
