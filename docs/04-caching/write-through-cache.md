...
[Back to Caching topics](README.md) | [Module guide](../04-caching.md)

## Learning checklist

- [ ] Explain Write-Through Cache in your own words.
...
1. What requirement makes Write-Through Cache relevant?
...
Apply this topic to the exercise in the [Module 04 guide](../04-caching.md), then record the decision and its trade-offs.
