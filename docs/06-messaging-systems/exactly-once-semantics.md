...
[Back to Messaging Systems topics](README.md) | [Module guide](../06-messaging-systems.md)

## Learning checklist

- [ ] Explain Exactly-Once Semantics in your own words.
...
1. What requirement makes Exactly-Once Semantics relevant?
...
Apply this topic to the exercise in the [Module 06 guide](../06-messaging-systems.md), then record the decision and its trade-offs.
