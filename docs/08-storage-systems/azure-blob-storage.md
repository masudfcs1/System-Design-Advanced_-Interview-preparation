...
[Back to Storage Systems topics](README.md) | [Module guide](../08-storage-systems.md)

## Learning checklist

- [ ] Explain Azure Blob Storage in your own words.
...
1. What requirement makes Azure Blob Storage relevant?
...
Apply this topic to the exercise in the [Module 08 guide](../08-storage-systems.md), then record the decision and its trade-offs.
