...
[Back to Scaling topics](README.md) | [Module guide](../10-scaling.md)

## Learning checklist

- [ ] Explain Multi-Region Deployment in your own words.
...
1. What requirement makes Multi-Region Deployment relevant?
...
Apply this topic to the exercise in the [Module 10 guide](../10-scaling.md), then record the decision and its trade-offs.
