...
[Back to Kubernetes topics](README.md) | [Module guide](../15-kubernetes.md)

## Learning checklist

- [ ] Explain PersistentVolume in your own words.
...
1. What requirement makes PersistentVolume relevant?
...
Apply this topic to the exercise in the [Module 15 guide](../15-kubernetes.md), then record the decision and its trade-offs.
