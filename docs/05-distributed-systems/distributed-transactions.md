...
[Back to Distributed Systems topics](README.md) | [Module guide](../05-distributed-systems.md)

## Learning checklist

- [ ] Explain Distributed Transactions in your own words.
...
1. What requirement makes Distributed Transactions relevant?
...
Apply this topic to the exercise in the [Module 05 guide](../05-distributed-systems.md), then record the decision and its trade-offs.
