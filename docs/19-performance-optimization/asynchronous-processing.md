...
[Back to Performance Optimization topics](README.md) | [Module guide](../19-performance-optimization.md)

## Learning checklist

- [ ] Explain Asynchronous Processing in your own words.
...
1. What requirement makes Asynchronous Processing relevant?
...
Apply this topic to the exercise in the [Module 19 guide](../19-performance-optimization.md), then record the decision and its trade-offs.
