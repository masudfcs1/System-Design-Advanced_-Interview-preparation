...
[Back to Staff and Principal Topics topics](README.md) | [Module guide](../21-advanced-topics.md)

## Learning checklist

- [ ] Explain Conflict-Free Replicated Data Types (CRDTs) in your own words.
...
1. What requirement makes Conflict-Free Replicated Data Types (CRDTs) relevant?
...
Apply this topic to the exercise in the [Module 21 guide](../21-advanced-topics.md), then record the decision and its trade-offs.
